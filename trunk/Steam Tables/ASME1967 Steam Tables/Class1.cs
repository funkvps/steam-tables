...
public double vistv (double temperature, double density)
   ...
   /*  DYNAMIC VISCOSITY (lbfs/ft/ft) as a function of temperature (F), pressure (psia),
...
public Double hpx(Double presion, Double calidad)
{
    ...
    Double entalpialiquido = 0;
    entalpialiquido = shvptx(presion, temperaturasaturacion, calidadliquidosaturado, 2);
    Double entropialiquido = 0;
    entropialiquido = shvptx(presion, temperaturasaturacion, calidadliquidosaturado, 1);

    //Vapor saturado
    Double calidadvaporsaturado = 100;
    Double entalpiavapor = 0;
    entalpiavapor = shvptx(presion, temperaturasaturacion, calidadvaporsaturado, 2);
    Double entropiavapor = 0;
    entropiavapor = shvptx(presion, temperaturasaturacion, calidadvaporsaturado, 1);

    //Mezcla liquido-vapor
    Double entalpia = (entalpialiquido * (1 - (calidad/100))) + ((calidad/100) * entalpiavapor);
    Double temperatura = tpshvx(presion, entalpia, calidad, 2, 1);
    Double entropia = (entropialiquido * (1 - (calidad/100))) + ((calidad/100) * entropiavapor);
...
public Double htx(Double temperatura, Double calidad)
{
    ...
    Double calidadliquidosaturado = 0;
    Double entalpialiquido = 0;
    entalpialiquido = shvptx(presionsaturacion, temperatura, calidadliquidosaturado, 2);
    Double entropialiquido = 0;
    entropialiquido = shvptx(presionsaturacion, temperatura, calidadliquidosaturado, 1);

    //Vapor saturado
    Double calidadvaporsaturado = 100;
    Double entalpiavapor = 0;
    entalpiavapor = shvptx(presionsaturacion, temperatura, calidadvaporsaturado, 2);
    Double entropiavapor =0;
    entropiavapor = shvptx(presionsaturacion, temperatura, calidadvaporsaturado, 1);
...
public Double vmediaph(Double presion1,Double entalpia1, Double presion2, Double entalpia2)
{
    Double calidad1 = xpshv(presion1, entalpia1, 2);
    Double temperatura1 = tpshvx(presion1, entalpia1, calidad1, 2, 1);
    Double entropia1 = shvptx(presion1, temperatura1, calidad1, 1);
    Double volumenespecifico1 = shvptx(presion1, temperatura1, calidad1, 3);

    Double calidad2 = xpshv(presion2, entalpia2, 2);
    Double temperatura2 = tpshvx(presion2, entalpia2, calidad2, 2, 1);
    Double entropia2 = shvptx(presion2, temperatura2, calidad2, 1);
    Double volumenespecifico2 = shvptx(presion2, temperatura2, calidad2, 3);

    Double volumenespecificomedio=(volumenespecifico1+volumenespecifico2)/2;

    return volumenespecificomedio;
}
